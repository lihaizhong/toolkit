...
window.onload = function () {
  ...
  var isAniFinished = true
  // 获取切换的页面的数量
  var time = 1
  var pageLength = document.getElementsByClassName('tq-slider-page').length
  var resizeTimer; var wheelTimer; var pageHeight; var lastAinFinishedTime; var preWheelTime; var curWheelTime = 0
  var EVENT_TRANSITION_END = 'ontransitionend' in window ? 'transitionend' : 'webkittransitionend'
  var EVENT_WHEEL = 'onwheel' in window ? 'wheel' : 'mousewheel'
